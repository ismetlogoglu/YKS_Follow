...
- `NEXT_PUBLIC_SUPABASE_URL` → yeni proje adresi
...
Birkaç öğrenciyle giriş + kayıt + deneme girişi dene. Her şey yerindeyse eski Seul
projesini Supabase panelinden duraklat/sil.
